      ...
      <div class="AknFullPage-content<% if (typeof picture !== \'undefined\' || typeof illustrationClass !== \'undefined\') { %> AknFullPage-content--withIllustration<% } %>">\
        ...
        <div>\
          ...
          <div class="AknButtonList">\
            ...
            <% } %>\
            <div id="<%- okText %>_pcmt_override" title="<%- okText %>" class="AknButton AknButtonList-item AknButton--apply<% if (typeof buttonClass !== \'undefined\') { %> <%- buttonClass %><% } %> ok"><%- okText %></div>\
          </div>\
        </div>\
      </div>\
    </div>\
