...
namespace Pcmt\PcmtProductBundle\JobParameters\DefaultValueProvider;
...
class XmlReferenceDataDownload implements DefaultValuesProviderInterface
{
    ...
    public function getDefaultValues(): array
    {
        return [
            ...
            'dirPath'  => 'src/Pcmt/PcmtProductBundle/Resources/config/' . $this->fileDirectory . $this->refDirName . '/',
            'filePath' => null,
        ];
    }
