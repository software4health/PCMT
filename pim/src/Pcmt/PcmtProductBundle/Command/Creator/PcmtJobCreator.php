...
namespace Pcmt\PcmtProductBundle\Command\Creator;

use Doctrine\ORM\EntityManagerInterface;
use Pcmt\PcmtProductBundle\Exception\InvalidJobConfigurationException;
use Pcmt\PcmtProductBundle\Exception\UnknownJobException;
use Pcmt\PcmtProductBundle\Registry\PcmtConnectorJobParametersRegistry;
