...
class PcmtProductNormalizerTest extends TestCase
{
    ...
    {
        $this->productNormalizerMock->expects($this->once())->method('normalize')->willReturn([]);

        $normalizer = new PcmtProductNormalizer($this->productNormalizerMock, $this->entityManagerMock);
    ...
    {
        $this->productNormalizerMock->expects($this->once())->method('supportsNormalization')->willReturn($value);
        $normalizer = new PcmtProductNormalizer($this->productNormalizerMock, $this->entityManagerMock);
