...
namespace PcmtProductBundle\Tests\Updater;
...
use PcmtProductBundle\Extension\PcmtAttributeManager;
use PcmtProductBundle\Updater\AttributeUpdater;
use PcmtProductBundle\Updater\TranslatableUpdater;
