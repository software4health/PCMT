...
namespace PcmtProductBundle\Command;

use Doctrine\ORM\EntityManagerInterface;
use PcmtProductBundle\Exception\InvalidJobConfigurationException;
...
class InitializeReferenceDataImport extends ContainerAwareCommand
{
     ...
     *
     * @throws \PcmtProductBundle\Exception\InvalidJobConfigurationException
     */
