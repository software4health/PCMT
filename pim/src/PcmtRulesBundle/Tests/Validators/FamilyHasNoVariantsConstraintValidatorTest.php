...
use PcmtRulesBundle\Tests\TestDataBuilder\FamilyHasNoVariantsConstraintBuilder;
use PcmtRulesBundle\Tests\TestDataBuilder\FamilyVariantBuilder;
use PcmtRulesBundle\Validators\FamilyHasNoVariantsConstraintValidator;
...
class FamilyHasNoVariantsConstraintValidatorTest extends TestCase
{
    ...
    public function testValidate(FamilyInterface $family, int $expectedViolations): void
    {
        ...
        $constraint = (new FamilyHasNoVariantsConstraintBuilder())->build();
    ...
    private function getValidatorInstance(): FamilyHasNoVariantsConstraintValidator
    {
        $validator = new FamilyHasNoVariantsConstraintValidator(
            $this->familyRepositoryMock
        );
